...
const BG = "#09090b"   // page background
const S1 = "#18181b"   // surface 1
const S2 = "#27272a"   // surface 2 / border
const T1 = "#fafafa"   // text primary
const T2 = "#a1a1aa"   // text secondary
const T3 = "#52525b"   // text tertiary
...
function SectionHead({ label, title, sub }) {
  return (
    <div style={{ textAlign: "center", marginBottom: 56 }}>
      ...
      <h2 style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-0.03em", color: T1, marginBottom: 14, lineHeight: 1.15 }}>
        {title}
      </h2>
      {sub && (
        <p style={{ fontSize: 17, color: T2, maxWidth: 540, margin: "0 auto", lineHeight: 1.6 }}>
          {sub}
        </p>
      )}
    </div>
...
function Card({ children, style = {}, hover = false }) {
  ...
  return (
    <div
      style={{
        background: S1,
        border: `1px solid ${hov && hover ? "#3f3f46" : S2}`,
...
// ✅ Each nav link is its own component so useState is called at the top level
...
function Navbar() {
  ...
  return (
    <nav style={{
      ...
      background: sc ? "rgba(9,9,11,0.9)" : "transparent",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
          ...
          {/* ✅ FIXED: NavLink component used instead of hook-inside-map */}
...
function CodeLine({ children }) {
  const parts = children.split(
    /('.*?'|\/\/.*$|\b(?:async|await|const|let|return|new)\b|\b(?:event|email|group|plan|source|name|member)\b|\b(?:on|create|log)\b)/gm
  )
  return (
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: `radial-gradient(circle at 1px 1px, ${S2} 1px, transparent 0)`,
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 32 }}>
          <a href="#" style={{
            ...
            background: S1, border: `1px solid ${S2}`,
            borderRadius: 99, padding: "6px 16px",
            fontSize: 12, color: T2, textDecoration: "none",
          }}>
            <span style={{ color: G, fontWeight: 700 }}>NEW</span>
            Now supporting 40+ Skool API endpoints
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
                ...
                {[78, 14, 10, 44, 96].map((n, i) => (
                  <img
                    ...
                    style={{
                      ...
                      border: `2px solid ${BG}`,
                      marginLeft: i ? -8 : 0, objectFit: "cover",
                    }}
                  />
                ))}
              </div>
              <span style={{ fontSize: 13 }}>
                <strong style={{ color: T1, fontWeight: 700 }}>2,400+</strong>{" "}
                <span style={{ color: T3 }}>groups connected</span>
              </span>
          ...
          {/* Right: code card */}
          <div style={{
            background: "#0d0d0f", border: `1px solid ${S2}`,
            borderRadius: 18, overflow: "hidden",
            boxShadow: "0 40px 100px rgba(0,0,0,0.6)",
          }}>
            {/* Title bar */}
            <div style={{
              padding: "11px 16px", background: S1,
              borderBottom: `1px solid ${S2}`,
              display: "flex", alignItems: "center", gap: 7,
            }}>
              {["#ef4444", "#f59e0b", "#22c55e"].map(clr => (
                <div key={clr} style={{ width: 10, height: 10, borderRadius: "50%", background: clr }} />
              ))}
              <span style={{ marginLeft: 6, fontSize: 11, color: T3, fontFamily: "monospace" }}>
                skoolapi-webhook.js
              </span>
            </div>
            {/* Code */}
        ...
        <p style={{ textAlign: "center", marginTop: 48, fontSize: 12, color: T3 }}>
          No credit card required · Free sandbox · Ships in 2 minutes
        </p>
      </div>
    </section>
  )
...
function StatCard({ value, suffix, label, active }) {
  ...
  const display =
    value >= 1000000000 ? `${(count / 1000000000).toFixed(1)}B+`
    : value >= 1000000  ? `${(count / 1000000).toFixed(1)}M+`
    : count >= 1000     ? `${(count / 1000).toFixed(1)}K+`
    : `${count}${suffix}`
  return (
    <div style={{ textAlign: "center", padding: "32px 16px" }}>
      <div style={{ fontSize: 48, fontWeight: 800, letterSpacing: "-0.04em", color: T1, lineHeight: 1 }}>
        {display}
      </div>
  ...
  return (
    <section style={{ padding: "60px 0", overflow: "hidden" }}>
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        <p style={{ fontSize: 13, color: T3, fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase" }}>
        ...
        {items.map((int, i) => (
          <div key={i} style={{
            ...
            <div style={{
              ...
              background: int.bg, color: int.fg,
  ...
  return (
    <section style={{ padding: "100px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          label="What operators are saying"
          title="Trusted by community operators worldwide"
          sub="Real results from teams building on SkoolAPI Cloud."
        />
            ...
            <Card key={i} hover>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                <div style={{
                  ...
                  background: t.color + "22", border: `2px solid ${t.color}40`,
                  display: "flex", alignItems: "center", justifyContent: "center",
  ...
  return (
    <section style={{ padding: "100px 0", background: S1 + "80" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          label="API Endpoints"
          title="40+ endpoints. One consistent interface."
          sub="Members, billing, courses, analytics, webhooks — all normalized with predictable pagination, filtering, and error handling."
        />
          ...
          {ENDPOINTS.map((ep, i) => (
            <Card key={i} hover style={{ padding: "20px 22px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                <Method m={ep.method} />
                <code style={{ fontSize: 11, color: T3, fontFamily: "monospace", background: S2 + "60", padding: "3px 8px", borderRadius: 4 }}>
                  {ep.route}
                </code>
              </div>
  ...
  return (
    <section style={{ padding: "100px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          label="Why SkoolAPI"
          title="SkoolAPI vs DIY vs Other Tools"
          sub="Stop duct-taping. See what a real platform gives you."
        />
        <div style={{ background: S1, border: `1px solid ${S2}`, borderRadius: 16, overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", borderBottom: `1px solid ${S2}` }}>
            ...
            {cols.map((col, i) => (
              <div key={i} style={{
                ...
                background: i === 0 ? G + "10" : "transparent",
                borderLeft: `1px solid ${S2}`,
              }}>
                <span style={{ fontSize: 13, fontWeight: 700, color: i === 0 ? G : T2 }}>{col}</span>
              </div>
            ))}
          </div>
          {/* Data rows */}
          {COMPARISON.map((row, i) => (
            <div key={i} style={{
              ...
              borderBottom: i < COMPARISON.length - 1 ? `1px solid ${S2}` : "none",
              background: i % 2 === 1 ? S2 + "20" : "transparent",
            }}>
              ...
              {[row.skool, row.diy, row.other].map((v, j) => (
                <div key={j} style={{
                  ...
                  borderLeft: `1px solid ${S2}`,
                  background: j === 0 ? G + "08" : "transparent",
                }}>
                  <Check val={v} />
                </div>
              ))}
  ...
  return (
    <section style={{ padding: "100px 0", background: S1 + "60" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          label="How it works"
          title="How SkoolAPI Replaces Your Duct-Tape Stack"
          sub="Stop stitching together Zapier, spreadsheets, and browser scripts. Get a real API."
        />
        {/* Tab toggle */}
            ...
            {[["with", "With SkoolAPI"], ["without", "Without SkoolAPI"]].map(([k, l]) => (
              <button
                ...
                style={{
                  ...
                  background: tab === k ? (k === "with" ? G : "#ef4444") : "transparent",
                  color: tab === k ? (k === "with" ? "#000" : "#fff") : T2,
                  transition: "all 0.2s",
                }}
              >
                {l}
        ...
        {tab === "with" ? (
            ...
            {STEPS.map((s, i) => (
              <Card key={i} style={{ borderTop: `2px solid ${G}` }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 16, fontWeight: 800, color: G, marginBottom: 16,
                }}>
                  {s.n}
                </div>
          ...
          <div style={{ background: S1, border: `1px solid #ef444440`, borderRadius: 16, padding: 32, maxWidth: 720, margin: "0 auto" }}>
            {WITHOUT.map((w, i) => (
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: i < WITHOUT.length - 1 ? 14 : 0 }}>
    ...
    <section style={{ padding: "100px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          ...
          title="Every community event, delivered in real time"
          sub="Members, payments, posts, comments, courses, moderation — subscribe to the events that matter."
        />
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 16 }}>
          {WEBHOOK_EVENTS.map((ev, i) => (
            <Card key={i} hover style={{ padding: "20px 22px" }}>
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: 10 }}>
                ...
                <span style={{ fontSize: 10, color: T3, background: S2 + "60", padding: "3px 8px", borderRadius: 4, whiteSpace: "nowrap", flexShrink: 0 }}>
                  {ev.timing}
                </span>
              </div>
    ...
    <section style={{ padding: "100px 0", background: S1 + "60" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          ...
          title="Everything you need to build on Skool"
          sub="A complete developer platform — not just an API. Logs, SDKs, a playground, and the tooling you'd expect from Stripe or Twilio."
        />
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 20 }}>
          {FEATS.map((f, i) => (
            <Card key={i} hover style={{ display: "flex", gap: 18, alignItems: "flex-start" }}>
              <div style={{
                ...
                width: 44, height: 44, background: G + "18",
    ...
    <section style={{ padding: "100px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          ...
          sub="A dashboard, docs, and webhook management interface you'll actually enjoy using."
        />

        {/* Tab bar */}
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
          <div style={{ display: "flex", gap: 4, background: S1, border: `1px solid ${S2}`, borderRadius: 10, padding: 4 }}>
            {TABS.map((t, i) => (
              <button
                key={i}
                onClick={() => setTab(i)}
                style={{
                  ...
                  background: tab === i ? G : "transparent",
                  color: tab === i ? "#000" : T2,
                  transition: "all 0.2s",
                }}
              >
        ...
        <div style={{ background: S1, border: `1px solid ${S2}`, borderRadius: 20, overflow: "hidden", boxShadow: "0 24px 80px rgba(0,0,0,0.4)" }}>
          ...
          <div style={{ padding: "28px" }}>
            ...
            {tab === 0 && (
              <div>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 28 }}>
                  {[
                    ["Connected Groups", "24",    G         ],
                    ["Events Today",     "8.2K",  P         ],
                    ["Monthly MRR",      "$128K", A         ],
                    ["Churn Rate",       "3.2%",  "#ef4444" ],
                  ].map(([l, v, c]) => (
                ...
                <div style={{ background: BG, border: `1px solid ${S2}`, borderRadius: 12, padding: 20 }}>
                  ...
                  <div style={{ display: "flex", gap: 3, alignItems: "flex-end", height: 80 }}>
                    {[40,60,35,80,55,90,70,85,45,75,65,95,50,88,72,60,78,55,82,68,90,75,85,92].map((h, i) => (
                      <div key={i} style={{ flex: 1, height: `${h}%`, background: G + (i === 23 ? "ff" : "55"), borderRadius: "2px 2px 0 0" }} />
                    ))}
                  </div>
                </div>
              </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    {["Filter", "Export"].map(btn => (
                      <span key={btn} style={{ fontSize: 12, color: T3, background: S2, padding: "5px 12px", borderRadius: 6 }}>{btn}</span>
                    ))}
                  </div>
                </div>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ borderBottom: `1px solid ${S2}` }}>
                      {["Name", "Status", "Plan", "MRR", "Joined"].map(h => (
                        <th key={h} style={{ padding: "8px 12px", textAlign: "left", fontSize: 11, color: T3, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
            ...
            {tab === 2 && (
              <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 16 }}>
                {[
                  ["MRR Growth (30d)",  "+12.3%", G],
                  ["Retention Rate",    "94.2%",  P],
                  ["Avg LTV",           "$1,847", A],
                  ["Payment Recovery",  "71.4%",  G],
                ].map(([l, v, c]) => (
    ...
    <section style={{ padding: "100px 0", background: S1 + "60" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        ...
        <SectionHead
          ...
          sub="Pick a plan that matches your group count. All plans include the full API, webhooks, and logs."
        />
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 52 }}>
          ...
          <button
            ...
            style={{
              ...
              position: "relative", background: annual ? G : S2, transition: "background 0.25s",
            }}
          >
            <span style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }}>
          {PLANS.map((plan, i) => {
            ...
            return (
              <div key={i} style={{
                background: S1,
                border: `${featured ? 2 : 1}px solid ${featured ? G : S2}`,
                ...
                <div style={{ fontSize: 11, fontWeight: 600, color: T3, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 12 }}>
                  What's included:
                </div>
    ...
    <section style={{ padding: "100px 0" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px" }}>
        <SectionHead
          ...
          sub="Everything you need to know about SkoolAPI Cloud."
        />
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          {FAQS.map((faq, i) => (
            <div key={i} style={{
              background: S1,
              border: `1px solid ${open === i ? "#3f3f46" : S2}`,
              ...
              >
                ...
                <span style={{
                  color: open === i ? G : T3, fontSize: 18, flexShrink: 0,
              ...
              {open === i && (
                <div style={{ padding: "0 20px 18px", fontSize: 14, color: T2, lineHeight: 1.7 }}>
                  {faq.a}
                </div>
              )}
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
          {CARDS.map((card, i) => (
            <Card key={i} style={{ borderTop: `2px solid ${G}` }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: T1, marginBottom: 10 }}>{card.title}</div>
              <div style={{ fontSize: 13, color: T2, lineHeight: 1.7 }}>{card.desc}</div>
            </Card>
          ))}
        </div>
      </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
          {[78, 14, 44, 10].map((n, i) => (
            <img
              ...
              src={`https://randomuser.me/api/portraits/men/${n}.jpg`}
              alt=""
              style={{ width: 32, height: 32, borderRadius: "50%", border: `2px solid ${BG}`, marginLeft: i ? -10 : 0, objectFit: "cover" }}
            />
          ))}
        </div>
        <Stars />
        <p style={{ fontSize: 12, color: T3, marginTop: 4, marginBottom: 32 }}>4.8 on Trustpilot</p>
        <h2 style={{ fontSize: 46, fontWeight: 800, letterSpacing: "-0.035em", color: T1, lineHeight: 1.1, marginBottom: 20 }}>
          Stop duct-taping.<br />Start building.
        </h2>
        <p style={{ fontSize: 17, color: T2, marginBottom: 40, lineHeight: 1.6 }}>
          Join 2,400+ connected groups using SkoolAPI Cloud to power their Skool integrations.
        </p>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: T3, lineHeight: 1.7, maxWidth: 220, marginBottom: 16 }}>
              The control plane for Skool operators. API + webhooks + analytics + automation.
            </p>
          ...
          {COLS.map(col => (
            <div key={col.title}>
              <div style={{ fontSize: 12, fontWeight: 700, color: T1, marginBottom: 14, textTransform: "uppercase", letterSpacing: "0.06em" }}>
                {col.title}
              </div>
              {col.links.map(l => (
                <a
                  key={l}
                  href="#"
                  style={{ display: "block", fontSize: 13, color: T3, textDecoration: "none", marginBottom: 8, transition: "color 0.2s" }}
